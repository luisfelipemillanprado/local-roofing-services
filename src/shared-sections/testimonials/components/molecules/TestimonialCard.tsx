...
export const TestimonialCard = ({ avatar, quote, name, location, logo }: TestimonialCardProps) => (
  <figure className="grid h-full grid-rows-[auto_1fr_auto] gap-5 rounded-2xl border border-line bg-surface-panel p-6 shadow-md transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
