import { Home, Building2, Factory, type LucideIcon } from "lucide-react";
...
import type { PricingCardProps, PricingIconKey } from "@/shared-sections/pricing/types";

/* plan icons inlined here while the pricing section is temporary */
const ICONS: Record<PricingIconKey, LucideIcon> = {
  home: Home,
  building: Building2,
  factory: Factory,
};
  ...
  return (
    <Reveal delay={delay}>
      ...
      >
        ...
        <span
          className={`grid size-14 place-items-center rounded-2xl ${highlighted ? "bg-primary" : "bg-surface-panel"}`}
        >
          <Icon className={`size-7 ${highlighted ? "text-white" : "text-primary"}`} />
        </span>
