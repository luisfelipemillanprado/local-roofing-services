...
import type { OfficeCardProps } from "@/shared-sections/service-areas/types";

/* full-bleed tile: image fills the cell, city over address on the bottom scrim */
export const OfficeCard = ({ image, title, description, action, sizes }: OfficeCardProps) => (
