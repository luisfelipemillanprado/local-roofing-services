...
export const AvailabilityBadge = ({ label }: AvailabilityBadgeProps) => (
  <div className="inline-grid max-w-full grid-cols-[auto_minmax(0,1fr)] items-center gap-2 rounded-badge border border-white/20 bg-white/5 px-4 py-2">
    <LiveDot />
    <Text size="note" tone="white" weight="semibold" tracking="subtle" truncate text={label} />
  </div>
);
