...
export const ActionButton = ({ label }: ActionButtonProps) => (
  <button
    type="submit"
    className="group inline-grid grid-flow-col items-center justify-center gap-2 rounded-full bg-primary px-7 py-4 transition-all duration-300 hover:-translate-y-0.5"
  >
