...
const sizes: Record<TextSize, string> = {
  ...
  body: "text-[clamp(0.95rem,0.8rem+0.6667vw,0.98125rem)] leading-relaxed" /* fluid 15.2→15.7px, 360→435vw — card body, buttons, navbar, footer, hero rating, contact phone */,
  caption:
