...
const sizes: Record<TextSize, string> = {
  ...
  caption:
    "text-[clamp(0.8375rem,0.6575rem+0.8vw,0.875rem)] leading-relaxed" /* fluid 13.4→14px, 360→435vw — marquee, stat captions, contact/years labels, product meta, filter counts, icon highlights */,
  note: "text-[clamp(0.825rem,0.675rem+0.6667vw,0.85625rem)] leading-relaxed" /* fluid 13.2→13.7px, 360→435vw — hero availability badge, shop product meta, filter titles, review count, area counties */,
  label:
