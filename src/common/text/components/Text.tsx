...
const sizes: Record<TextSize, string> = {
  subhead:
    "text-[clamp(1rem,0.7rem+1.3333vw,1.0625rem)] leading-relaxed" /* fluid 16→17px, 360→435vw — FAQ questions, shop tab labels, product share label */,
  ...
  body: "text-[clamp(0.95625rem,0.83625rem+0.5333vw,0.98125rem)] leading-relaxed" /* fluid 15.3→15.7px, 360→435vw — card body, buttons, navbar, footer, hero rating, contact phone, shop tab prose */,
  caption:
