...
const sizes: Record<TextSize, string> = {
  subhead:
    "text-[clamp(1rem,0.7rem+1.3333vw,1.0625rem)] leading-relaxed" /* fluid 16→17px, 360→435vw — FAQ questions, shop tab labels, product share label and spec values */,
  lead: "text-[clamp(0.95625rem,0.74625rem+0.9333vw,1rem)] leading-relaxed" /* fluid 15.3→16px, 360→435vw — section/page descriptions, footer tagline, shop tabs */,
  body: "text-[clamp(0.95625rem,0.83625rem+0.5333vw,0.98125rem)] leading-relaxed" /* fluid 15.3→15.7px, 360→435vw — card body, buttons, navbar, footer, hero rating, contact phone, shop tab prose, product price unit, stock and rating */,
  caption:
    "text-[clamp(0.8375rem,0.6575rem+0.8vw,0.875rem)] leading-relaxed" /* fluid 13.4→14px, 360→435vw — marquee, stat captions, contact/years labels, product meta, review count, icon highlights */,
  note: "text-[clamp(0.825rem,0.675rem+0.6667vw,0.85625rem)] leading-relaxed" /* fluid 13.2→13.7px, 360→435vw — hero availability badge, shop product meta */,
  label:
