...
- **Uniform word counts per field**, matched across every item of a section in **both**
  locales (e.g. team card descriptions 5 words, pitch card descriptions 13 EN / 12 ES,
  testimonial quotes 25 words in 2 sentences, shared-section descriptions 20). Person names use the
  format **`First N. Last`**.
